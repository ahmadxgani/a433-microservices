...
# load/memuat env variabel yang ada pada file .env.local
export $(grep -v '^#' .env.local | xargs)

# declare variabel yang dibutuhkan
TAG="latest"
USERNAME="ahmadxgani"
IMAGE_NAME="karsajobs-ui:${TAG}"
...
echo "============================================================"
# login ke github container registry menggunakan classic token yang sudah di set di .env.local sebelum nya
